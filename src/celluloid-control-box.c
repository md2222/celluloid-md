...
celluloid_control_box_class_init(CelluloidControlBoxClass *klass)
{
    ...
    gtk_widget_class_set_css_name(wgt_class, "celluloid-control-box");    //-
...
celluloid_control_box_init(CelluloidControlBox *box)
{
    ...
    // MD 
    gtk_box_set_spacing (&box->parent_instance, 5);
    ...
    // MD
	gtk_style_context_add_class (gtk_widget_get_style_context(GTK_WIDGET(box)), GTK_STYLE_PROPERTY_PADDING);

...
connect_signals(CelluloidController *controller)
{
	...
	//g_object_bind_property(controller->model, "media-title", controller->view, "title", G_BINDING_DEFAULT);
	g_object_bind_property(controller->model, "path", controller->view, "title", G_BINDING_DEFAULT);  //+
